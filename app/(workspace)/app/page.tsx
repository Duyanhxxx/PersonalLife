    ...
    <section className="p-6 md:p-10">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div>
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-[#05386B]">
        ...
        <div>
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.18em] text-[#379683]">
            Go to section
          </p>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {sections.map((section) => {
              ...
              return (
                <Link
                  className="rounded-[1.75rem] border border-[#8EE4AF]/45 bg-white/70 p-5 transition hover:border-[#379683] hover:shadow-md"
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-[#20555F]">
                    {theme.description}
                  </p>
                </Link>
              );
